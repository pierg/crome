...
from crome.logic.patterns import Pattern
from crome.logic.specification import Cnf, Dnf, Specification
from crome.logic.specification.boolean import Bool
from crome.logic.specification.temporal.tools import transform_spot_tree
from crome.logic.specification.tools import is_true_string
from crome.logic.specification.trees import (
    boolean_tree_to_formula,
    extract_atoms_dictionary,
    gen_atoms_tree,
    gen_ltl_tree,
)
from crome.logic.tools.atomic_propositions import extract_ap
from crome.logic.tools.nuxmv import check_satisfiability, check_validity
from crome.logic.typelement.basic import (
    Boolean,
    BooleanControllable,
    BooleanUncontrollable,
)
from crome.logic.typelement.robotic import BooleanLocation, BooleanSensor
...
class LTL(Specification):
    ...
    def adjacency_rules(self) -> LTL:
        from crome.logic.specification.rules_extractors import extract_adjacency_rules

        return extract_adjacency_rules(self.typeset)

    @property
    def mutex_rules(self) -> LTL:
        from crome.logic.specification.rules_extractors import extract_mutex_rules
