...
from crome.cgg.shared.paths import output_folder_cgg
from crome.cgg.tools.strings import tab, tabar
...
class Cgg:
    ...
    def _build_graph(self) -> None:
        from crome.cgg.cgg.context_based_clustering import context_based_goal_clustering
