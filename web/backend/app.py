...
from web.backend.shared.paths import build_path, project_path, storage_path
...
import web.backend.flask_handlers.contracts  # NOQA
import web.backend.flask_handlers.crome  # NOQA
...
if __name__ == "__main__":
    if args.dev:
        ...
        socketio.run(app, host="0.0.0.0", port=8000, certfile="cert.pem", keyfile="privkey.pem")
