...
import crome.cgg.cgg as crome_cgg
from crome.cgg.context import ContextException
from web.backend.app import build_simple_project, copy_simple, send_message_to_user
from web.backend.operations.simulation import Simulation
from web.backend.shared.paths import project_path, storage_path
from web.backend.tools.persistence import dump_cgg, load_cgg, load_goals
from web.backend.utility.goal import GoalUtility
from web.backend.utility.project import ProjectUtility
...
def get_patterns() -> None:
    ...
    """
    from crome.logic.patterns.robotic_movement import CoreMovement
    from crome.logic.patterns.robotic_triggers import Trigger
...
def process_goals(project_id) -> None:
    ...
    from crome.cgg.goal.exceptions import GoalException
