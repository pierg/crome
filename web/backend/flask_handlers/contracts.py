...
from crome.cgg.goal.exceptions import GoalAlgebraOperationFail
from web.backend.app import send_message_to_user
from web.backend.operations.analysis import Analysis
from web.backend.shared.paths import project_path
from web.backend.tools.persistence import load_cgg
